...
uint8_t *const row_ddr[MATRIX_ROWS] = {
           _DDRD,  _DDRD,  _DDRD,  _DDRD,
           _DDRF,  _DDRF,  _DDRF,  _DDRF};

static
uint8_t *const row_port[MATRIX_ROWS] = {
          _PORTD, _PORTD, _PORTD, _PORTD,
          _PORTF, _PORTF, _PORTF, _PORTF};

static
uint8_t *const row_pin[MATRIX_ROWS] = {
           _PIND,  _PIND,  _PIND,  _PIND,
           _PINF,  _PINF,  _PINF,  _PINF};

static
const uint8_t row_bit[MATRIX_ROWS] = {
           _BIT0,  _BIT1,  _BIT2,  _BIT3,
           _BIT4,  _BIT5,  _BIT6,  _BIT7};

static
const uint8_t mask = 0x1E;

/* Specifies the ports and pin numbers for the columns */
static
const uint8_t   col_bit[MATRIX_COLS] = {	0x18,	0x10,   0x0C,   0x04,   0x00,   0x02,   0x0A,   0x06,   0x08,   0x12,   0x0E,   0x1A,   0x16,   0x1E,   0x14,   0x1C};
//const uint8_t   col_bit[MATRIX_COLS] = {  0x00,   0x02,   0x04,   0x06,   0x08,   0x0A,   0x0C,   0x0E,   0x10,   0x12,   0x14,   0x16,   0x18,   0x1A,   0x1C,   0x1E};
