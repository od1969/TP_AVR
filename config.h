...
#define PRODUCT         "TP_AVR"
#define USBSTR_PRODUCT 'T', '\x00', 'P', '\x00', '_', '\x00', 'A', '\x00', 'V', '\x00', 'R', '\x00'
#define DESCRIPTION     "TP_AVR by QMK"
...
// Device uses custom matrix code to accomodate a 74HC238 3 to 8 decoder on pins B1, B2 ,B3 and B4.
